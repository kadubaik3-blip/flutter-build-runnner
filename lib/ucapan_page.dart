...
class _UcapanPageState extends State<UcapanPage> {
  ...
  Future<void> _loadUcapan() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://public-gacor67.zone.id:2357/getUcapan?key=$_sessionKey'),
      );
  ...
  Future<void> _tambahUcapan() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://public-gacor67.zone.id:2357/addUcapan'),
  ...
  Future<void> _likeUcapan(String id, String type) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://public-gacor67.zone.id:2357/likeUcapan'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'key': _sessionKey,
          'id': id,
  ...
  Future<void> _deleteUcapan(String id) async {
    ...
    try {
      final response = await http.delete(
        Uri.parse('http://public-gacor67.zone.id:2357/deleteUcapan'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'key': _sessionKey,
          'id': id,
