...
class _UcapanPageState extends State<UcapanPage> {
  ...
  Future<void> _loadUcapan() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://server.lynzzofficial.com:2014/getUcapan?key=$_sessionKey'),
      );
  ...
  Future<void> _tambahUcapan() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://server.lynzzofficial.com:2014/addUcapan'),
  ...
  Future<void> _likeUcapan(String id, String type) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://server.lynzzofficial.com:2014/likeUcapan'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'key': _sessionKey,
          'id': id,
  ...
  Future<void> _deleteUcapan(String id) async {
    ...
    try {
      final response = await http.delete(
        Uri.parse('http://server.lynzzofficial.com:2014/deleteUcapan'),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'key': _sessionKey,
          'id': id,
