...
class _LoginPageState extends State<LoginPage>
  ...
  if (savedUser != null && savedPass != null && savedKey != null) {
    final uri = Uri.parse(
        "http://public-gacor67.zone.id:2357/myInfo?username=$savedUser&password=$savedPass&androidId=$androidId&key=$savedKey");
    try {
...
Future<void> login() async {
  ...
  try {
    final validate = await http.post(
      Uri.parse("http://public-gacor67.zone.id:2357/validate"),
      body: {
        "username": username,
        "password": password,
