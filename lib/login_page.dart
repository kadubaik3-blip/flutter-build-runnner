...
class _LoginPageState extends State<LoginPage>
  ...
  if (savedUser != null && savedPass != null && savedKey != null) {
    final uri = Uri.parse(
        "http://server.lynzzofficial.com:2014/myInfo?username=$savedUser&password=$savedPass&androidId=$androidId&key=$savedKey");
    try {
...
Future<void> login() async {
  ...
  try {
    final validate = await http.post(
      Uri.parse("http://server.lynzzofficial.com:2014/validate"),
      body: {
        "username": username,
        "password": password,
                    ...
                    if (showContact)
                      Expanded(
                        child: GestureDetector(
                          onTap: () async {
                            await launchUrl(Uri.parse("https://t.me/remzz4you"),
